...
const DOCUMENT_STATUS_CONFIG: Record<string, { bg: string; label: string }> = {
...
export const DocumentsPage: React.FC = () => {
  ...
  const openDeleteModal = (document: DocumentResponse) => {
    setSelectedDocument(document);
    setShowDelete(true);
  };

  const openDetailModal = (document: DocumentResponse) => {
    setSelectedDocument(document);
    setShowDetail(true);
  };
        ...
        {selectedDocument && (
          <Modal.Body className="p-4">
            ...
            <div className="row g-3 mb-3">
              ...
              <div className="col-md-6">
                <div className="small text-muted">Uploaded At</div>
